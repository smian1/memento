...
import { Check, Square, Edit2, Tag as TagIcon, Trash2, Zap, Bot, MoreVertical, X } from 'lucide-react';
...
export function ActionItem({ item, onUpdate, onDelete, showEditButton = false }: ActionItemProps) {
          ...
          <div className="more-menu-container">
            ...
            {showActionMenu && (
              <div className="menu-hover-container">
                ...
                {console.log('🔵 TAG SELECTOR RENDER CHECK:', { showTagSelector, showHoverMenu })}
